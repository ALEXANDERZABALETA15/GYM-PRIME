...
function WhatsAppButton(){
    const numero = "573133635338"
    const mensaje = "Hola! Me interesa obtener mas informacion sobre el gimnasio🦾"
    ...
    return(
        <a
        href ={url}
        target="_blank"   // target="_blank" → abre el enlace en una pestaña nueva
        rel="noopener noreferrer" // rel="noopener noreferrer" → seguridad al abrir enlaces externos
